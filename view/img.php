...
$header = str_replace("{{title}}", "Images for: $q", $header);
echo $header;
$choice = "image";
?>
        ...
        <div id="flex" class=" d-flex align-items-center justify-content-center flex-column query-flex margin-footer">
            ...
            <div class="container-fluid mt-4 mb-5">
                <div class="main-content mb-5">
                    ...
                    $counter = 0;
                    foreach ($imglist as $sitename => $link) {
                        $lowername = mb_strtolower($sitename);
                        $uppername = mb_strtoupper($sitename);
                        $div =<<<HTML
                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 my-2" data-index="$counter" data-site="$sitename" data-liked="None" data-section="image">
