...
$header = str_replace("{{title}}", "Videos for: $q", $header);
echo $header;
$choice = "video";
?>


<body id="bg-video" class="bg-image-video">
        ...
        <div id="flex" class=" d-flex align-items-center justify-content-center flex-column query-flex margin-footer">
            <div id="title-query" class=" query-box d-flex align-items-center justify-items-center mx-5  px-5">
                <div
                    ...
                    <h1 class="text-white oswald fs-main-title- mb-0 text-right">videos for
                    </h1>
                    <input type="text" id="query-video" class="d-inline-block oswald border-0 py-3 mx-3 mt-3 mt-md-0"
            ...
            <div class="container-fluid mt-4 mb-5">
                <div class="main-content mb-5">
                    ...
                    $counter = 0;
                    foreach ($videolist as $sitename => $link) {
                        $lowername = mb_strtolower($sitename);
                        $uppername = mb_strtoupper($sitename);
                        $div =<<<HTML
                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 my-2" data-index="$counter" data-site="$sitename" data-liked="None" data-section="video">
