...
$header = str_replace("{{title}}", "Icons for: $q", $header);
echo $header;
$choice = "icon";
?>
        ...
        <div id="flex" class=" d-flex align-items-center justify-content-center flex-column query-flex margin-footer">
            <div id="title-query" class=" query-box d-flex align-items-center justify-items-center mx-auto my-port-3">
                <div class="w-100 d-flex flex-column flex-sm-column flex-md-row align-items-center justify-content-around">
                    <h1 class="text-white oswald fs-query mb-0 text-right my-2">icons for
                    </h1>
            ...
            <div class="container-fluid mt-4 mb-5">
                <div class="main-content mb-5">
                    ...
                    $counter = 0;
                    foreach ($iconlist as $sitename => $link) {
                        $lowername = mb_strtolower($sitename);
                        $uppername = mb_strtoupper($sitename);
                        $div =<<<HTML
                            <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3 my-2" data-index="$counter" data-site="$sitename" data-liked="None" data-section="icon">
